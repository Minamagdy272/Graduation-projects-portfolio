...
This project proposes the design and implementation of a **Intelligent API Gateway** — a production-grade system engineered for high performance, reliability, and enterprise scalability. The system addresses critical operational challenges in Developer Tools / Networking by building a robust architecture that integrates modern software engineering practices with a bounded AI subsystem.
...
- Integrate a bounded AI module (Isolation Forest AI Web Application Firewall (WAF) abuse classifier) to enhance operational decision-making without creating single-point-of-failure model dependencies
...
4. **Bounded AI Subsystem** — Integrated ML inference service (Isolation Forest AI Web Application Firewall (WAF) abuse classifier) providing predictive scores to augment decision engines.
...
|-----------|---------|-----------|---------------|
| Predictive Analysis | Score incoming events for anomalies or future trends | Isolation Forest AI Web Application Firewall (WAF) abuse classifier | Provides adaptive insight where static rules are insufficient |
...
|----------|-----------|---------|---------|
| **Primary Stack** | Go, NGINX / Envoy, Lua, Redis, PostgreSQL, Python, Isolation Forest WAF, React, Prometheus | Latest | Core System Implementation |
...
|--------|----------|----------------|
| **Paymob** | Domestic Industry | Direct commercial alignment with project domain |
| ** Instabug** | Local Partner | Recruitment pipeline and technical validation |
...
2. Official Documentation for Go and  NGINX / Envoy.
