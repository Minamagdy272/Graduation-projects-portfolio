...
This project proposes the design and implementation of a **Core Banking Microservices Platform for Digital-Only Banks** — a production-grade system engineered for high performance, reliability, and enterprise scalability. The system addresses critical operational challenges in FinTech / Enterprise Systems by building a robust architecture that integrates modern software engineering practices with a bounded AI subsystem.
...
- Integrate a bounded AI module (XGBoost credit limit recommendation decisioning module) to enhance operational decision-making without creating single-point-of-failure model dependencies
...
4. **Bounded AI Subsystem** — Integrated ML inference service (XGBoost credit limit recommendation decisioning module) providing predictive scores to augment decision engines.
...
|-----------|---------|-----------|---------------|
| Predictive Analysis | Score incoming events for anomalies or future trends | XGBoost credit limit recommendation decisioning module | Provides adaptive insight where static rules are insufficient |
...
|----------|-----------|---------|---------|
| **Primary Stack** | Java (Spring Boot), Apache Kafka, PostgreSQL, Redis, Python, XGBoost, React, React Native | Latest | Core System Implementation |
...
|--------|----------|----------------|
| **CIB Egypt** | Domestic Industry | Direct commercial alignment with project domain |
...
| **Hardware** | Test devices / sensor kits / local server | 13,000 | ~260 |
| **Total** | | **~33000 EGP** | **~660 USD** |
...
2. Official Documentation for Java (Spring Boot) and  Apache Kafka.
