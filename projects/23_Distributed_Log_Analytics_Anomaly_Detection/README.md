...
This project proposes the design and implementation of a **Distributed Log Analytics and Anomaly Detection** — a production-grade system engineered for high performance, reliability, and enterprise scalability. The system addresses critical operational challenges in Observability / Big Data by building a robust architecture that integrates modern software engineering practices with a bounded AI subsystem.
...
- Integrate a bounded AI module (Drain NLP log template parser + DeepLog LSTM sequence anomaly detector) to enhance operational decision-making without creating single-point-of-failure model dependencies
...
4. **Bounded AI Subsystem** — Integrated ML inference service (Drain NLP log template parser + DeepLog LSTM sequence anomaly detector) providing predictive scores to augment decision engines.
...
### Backend
- **Core Engine:** Written in Rust / Go / Python for high-concurrency performance and thread-safe memory handling
...
**Total AI Subsystem Effort:** ~25% of overall engineering work (bounded building block)
...
|-----------|---------|-----------|---------------|
| Predictive Analysis | Score incoming events for anomalies or future trends | Drain NLP log template parser + DeepLog LSTM sequence anomaly detector | Provides adaptive insight where static rules are insufficient |
...
|----------|-----------|---------|---------|
| **Primary Stack** | Rust, Go, Apache Kafka, ClickHouse, Drain Parser, PyTorch (DeepLog LSTM), React | Latest | Core System Implementation |
...
| Rust / Go / Python Programming | Essential | Language Official Documentation & Guides |
...
|-------|---------------|-------|
| Rust / Go / Python Development | Advanced | Core service implementation |
...
|--------|------|-----------------|------------------|
| **Member 1** | Core Backend Lead | Design and implement main processing microservices, API layers, and business logic. | Rust / Go / Python, REST/gRPC |
...
- [ ] Complete core language (Rust / Go / Python) and streaming architecture training
...
|--------|----------|----------------|
| **Paymob Infrastructure** | Domestic Industry | Direct commercial alignment with project domain |
| ** Raya Data Center** | Local Partner | Recruitment pipeline and technical validation |
...
| **Hardware** | Test devices / sensor kits / local server | 28,000 | ~560 |
| **Total** | | **~48000 EGP** | **~960 USD** |
...
2. Official Documentation for Rust and  Go.
