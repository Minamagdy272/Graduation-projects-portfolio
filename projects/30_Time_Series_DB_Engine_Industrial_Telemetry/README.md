...
This project proposes the design and implementation of a **Time-Series Database Engine for Industrial Telemetry** — a production-grade system engineered for high performance, reliability, and enterprise scalability. The system addresses critical operational challenges in Database Systems / Infrastructure by building a robust architecture that integrates modern software engineering practices with a bounded AI subsystem.
...
- Integrate a bounded AI module (Native DETECT_ANOMALIES CUSUM streaming module) to enhance operational decision-making without creating single-point-of-failure model dependencies
...
4. **Bounded AI Subsystem** — Integrated ML inference service (Native DETECT_ANOMALIES CUSUM streaming module) providing predictive scores to augment decision engines.
...
### Backend
- **Core Engine:** Written in Go / Rust for high-concurrency performance and thread-safe memory handling
...
**Total AI Subsystem Effort:** ~15% of overall engineering work (bounded building block)
...
|-----------|---------|-----------|---------------|
| Predictive Analysis | Score incoming events for anomalies or future trends | Native DETECT_ANOMALIES CUSUM streaming module | Provides adaptive insight where static rules are insufficient |
...
|----------|-----------|---------|---------|
| **Primary Stack** | Go / Rust, Gorilla Encoding, WAL, LTTB Algorithm, CUSUM Anomaly Engine, React | Latest | Core System Implementation |
...
| Go / Rust Programming | Essential | Language Official Documentation & Guides |
...
|-------|---------------|-------|
| Go / Rust Development | Advanced | Core service implementation |
...
|--------|------|-----------------|------------------|
| **Member 1** | Core Backend Lead | Design and implement main processing microservices, API layers, and business logic. | Go / Rust, REST/gRPC |
...
- [ ] Complete core language (Go / Rust) and streaming architecture training
...
|--------|----------|----------------|
| **Elsewedy Digital** | Domestic Industry | Direct commercial alignment with project domain |
| ** Raya IT** | Local Partner | Recruitment pipeline and technical validation |
...
2. Official Documentation for Go / Rust and  Gorilla Encoding.
